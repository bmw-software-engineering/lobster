#!/usr/bin/env python3
"""Build the lobster-tool-gtest wheel by staging files expected by setup.py."""
...
def main() -> int:
    ...
    root = Path(workspace)
    package_dir = root / "packages" / "lobster-tool-gtest"
    ...
    # make: cp -Rv $(LOBSTER_ROOT)/lobster/tools/gtest lobster/tools
    shutil.copytree(root / "lobster" / "tools" / "gtest", staged_tools / "gtest")
