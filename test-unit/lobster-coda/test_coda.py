...
class LobsterCodaTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.output_file_name = f'{LOBSTER_GENERATOR}_{os.path.basename(self.test_case_file)}'
    ...
    def test_parse_config_file_with_two_markers_for_two_outputs(self):
        ...
        self.assertEqual(1, len(config_dict))
    ...
    def test_test_case_parsing(self):
        ...
        test_cases = ParserForRequirements.collect_test_cases(self.test_case_file)
