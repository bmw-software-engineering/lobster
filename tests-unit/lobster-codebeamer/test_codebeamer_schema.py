...
from lobster.tools.codebeamer.codebeamer import _create_common_params, _create_lobster_item, main, parse_yaml_config
...
class TestCreateFunctions(unittest.TestCase):
    ...
    def test_unsupported_config_keys(self):
        ...
        # Update sys.argv with the unsupported config file
