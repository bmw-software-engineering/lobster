#!/usr/bin/env python3
"""Build the lobster-tool-json wheel by staging files expected by setup.py."""
...
def main() -> int:
    ...
    root = Path(workspace)
    package_dir = root / "packages" / "lobster-tool-json"
    ...
    # make: cp -Rv $(LOBSTER_ROOT)/lobster/tools/json lobster/tools
    shutil.copytree(root / "lobster" / "tools" / "json", staged_tools / "json")
