#!/usr/bin/env python3
"""Build the lobster-tool-cpp wheel by staging files expected by setup.py."""
...
def main() -> int:
    ...
    root = Path(workspace)
    package_dir = root / "packages" / "lobster-tool-cpp"
    ...
    # make: cp -Rv $(LOBSTER_ROOT)/lobster/tools/cpp lobster/tools
    shutil.copytree(root / "lobster" / "tools" / "cpp", staged_tools / "cpp")
