...
for tool in "${TOOLS[@]}"; do
    ...
    lobster-python tests-system/lobster-$tool --activity \
        --out=tracing-out/system-tests.lobster
    lobster-python tests-unit/lobster-$tool --activity \
    ...
    # Generate HTML report (only reached if all above succeeded due to set -e)
