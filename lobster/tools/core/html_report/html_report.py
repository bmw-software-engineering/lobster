...
from lobster.tools.core.html_report.diagram_generator import create_policy_diagram_dot, create_policy_diagram_plotly, name_hash
...
def write_html(fd, report, dot, high_contrast, render_md):
    ...
    if is_dot_available(dot):
        create_policy_diagram_dot(doc, report, dot)
    else:
