...
class JsonJustificationAttributeTest(LobsterJsonSystemTestCaseBase):
    ...
    def test_justification_attribute_given_no_schema(self):
        self._test_runner.declare_input_file(
            self._data_directory / "justification_attribute_given.json")

        self._test_runner.config_file_data.justification_attribute = "Justification"
        out_file = "justification_attribute_given_no_schema.lobster"
        self._test_runner.cmd_args.out = out_file
        self._test_runner.declare_output_file(self._data_directory / out_file)
    ...
    def test_justification_attribute_given_but_key_missing_no_schema(self):
        self._test_runner.declare_input_file(
            self._data_directory / "justification_attribute_given.json")

        self._test_runner.config_file_data.justification_attribute = "missingkey"

        out_file = "justification_attribute_irrelavent_no_schema.lobster"
        self._test_runner.cmd_args.out = out_file
        self._test_runner.declare_output_file(self._data_directory / out_file)
    ...
    def test_justification_attribute_not_given_no_schema(self):
        self._test_runner.declare_input_file(
            self._data_directory / "justification_attribute_given.json")

        out_file = "justification_attribute_not_given_no_schema.lobster"
        self._test_runner.cmd_args.out = out_file
        self._test_runner.declare_output_file(self._data_directory / out_file)
