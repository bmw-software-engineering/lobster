...
# Config - SSL certificate paths differ by build system:
# - Bazel: certs generated by codebeamer_pem target, placed flat in data/
# - Make: certs committed at data/ssl/
_DATA_DIR = Path(__file__).parent / "data"
_BAZEL_CERT = _DATA_DIR / "cert.pem"
_MAKE_CERT = _DATA_DIR / "ssl" / "cert.pem"
CERT_PATH = str(_BAZEL_CERT if _BAZEL_CERT.exists() else _MAKE_CERT)
KEY_PATH = str(_DATA_DIR / "key.pem"
               if _BAZEL_CERT.exists()
               else _DATA_DIR / "ssl" / "key.pem")
