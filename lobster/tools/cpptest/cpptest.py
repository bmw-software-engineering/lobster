...
class CppTestTool(MetaDataToolBase):
    ...
    def _execute(self, options: Namespace) -> None:
        try:
            ...
            self._argument_parser.error(str(file_not_found_error))
        except ValueError as value_error:
            self._argument_parser.error(str(value_error))
        except KeyError as key_error:
            self._argument_parser.error(str(key_error))
        except LOBSTER_Error as lobster_error:
            self._argument_parser.error(str(lobster_error))
