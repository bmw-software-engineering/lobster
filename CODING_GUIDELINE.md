...
## Pylint
Following Pylint is mandatory and enforced through CI checks.
For legacy reasons, its configuration is given in several files:

| File | Scope |
| --- | --- |
| [pylint3.cfg](pylint3.cfg) | production code |
| [tests_system/pylint3.cfg](tests_system/pylint3.cfg) | system tests |
| [tests_unit/pylint3.cfg](tests_unit/pylint3.cfg) | unit tests |
...
Use the `SCREAMING_SNAKE_CASE` convention.
