#!/usr/bin/env python3
"""Build the lobster-tool-codebeamer wheel by staging files expected by setup.py."""
...
def main() -> int:
    ...
    root = Path(workspace)
    package_dir = root / "packages" / "lobster-tool-codebeamer"
    ...
    # make: cp -Rv $(LOBSTER_ROOT)/lobster/tools/codebeamer lobster/tools
    shutil.copytree(root / "lobster" / "tools" / "codebeamer", staged_tools / "codebeamer")
