...
class LobsterHtmlReportcontentTest(LobsterUISystemTestCaseBase):
    ...
    def test_item_unique_data_no_schema(self):
        # lobster-trace: html_req.Item_Data_Unique
        # lobster-trace: UseCases.Correct_Item_Data
        # lobster-trace: UseCases.Coverage_in_output
        # lobster-trace: UseCases.HTML_file_generation
        ...
        dot_present = is_dot_available(dot=None)
        if dot_present:
            output_filename = "octopus_tracing_policy_no_schema.html"
        else:
            output_filename = "octopus_no_schema.html"
        inputfile2 = self._data_directory / "report_octopus_yaml_no_schema.lobster"
    ...
    def test_complex_tracing_policy_data_no_schema(self):
        # lobster-trace: UseCases.Correct_Item_Data
        # lobster-trace: UseCases.Coverage_in_output
        # lobster-trace: UseCases.HTML_file_generation
        # lobster-trace: UseCases.List_of_tests_covering_requirements_in_HTML_file
        ...
        dot_present = is_dot_available(dot=None)
        if dot_present:
            output_filename = "pizza_tracing_policy_no_schema.html"
        else:
            output_filename = "pizza_no_schema.html"
        inputfile = self._data_directory / "report_pizza_yaml_no_schema.lobster"
    ...
    def test_multiple_input_files_in_working_directory_no_schema(self):
        # lobster-trace: html_req.Only_Given_Input_File_Consumed
        # lobster-trace: UseCases.Coverage_in_output
        # lobster-trace: UseCases.HTML_file_generation
        # lobster-trace: UseCases.Covered_Requirement_list_in_HTML_file
        ...
        if dot_present:
            ...
            output_filename = "pizza_no_schema.html"
        inputfile1 = self._data_directory / "report_pizza_yaml_no_schema.lobster"
        inputfile2 = self._data_directory / "report_octopus_yaml_no_schema.lobster"
    ...
    def test_message_in_item_no_schema(self):
        # lobster-trace: UseCases.Correct_Item_Data
        # lobster-trace: UseCases.Coverage_in_output
        # lobster-trace: UseCases.HTML_file_generation
        # lobster-trace: UseCases.Covered_Requirement_list_in_HTML_file
        ...
        if dot_present:
            ...
            output_filename = "octopus_no_schema.html"
        inputfile = self._data_directory / "report_octopus_yaml_no_schema.lobster"
    ...
    def test_text_in_html_report(self):
        ...
        with a text field.
        """
        output_filename = "text_pizza.html"
        inputfile = self._data_directory / "report_text_pizza.lobster"
